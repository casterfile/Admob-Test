...
public class GoogleAdsExample : MonoBehaviour {
	...
	void Start() {
		...
		string globalDUI = SystemInfo.deviceUniqueIdentifier;
		print ("globalDUI: "+globalDUI);
		Output1.text = globalDUI;
		GoogleMobileAd.AddTestDevice(globalDUI);
	...
	private void OnInterstitialLoaded () {
		...
		Output1.text = "OnInterstitialLoaded catched with C# Actions usage";
	}
